'use client';
import logoWhite from "../../../public/assets/img/logo/sitegrow-logo.png";
import logoBlack from "../../../public/assets/img/logo/sitegrow-logo.png";
                    ...
                    <div className="row align-items-center">
                        <div className="col-xl-2 col-lg-6 col-6">
                            <div className="tp-header-logo">
                                <Link href="/">
                                    <Image width={180} className="logo-white" src={logoWhite} alt="logo-white" />
                                    <Image width={180} className="logo-black d-none" src={logoBlack} alt="logo-black" />
                                </Link>
                            </div>
                        </div>
