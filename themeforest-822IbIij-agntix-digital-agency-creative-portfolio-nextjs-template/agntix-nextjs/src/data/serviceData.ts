...
const servicesData: servicesDT[] = [
    ...
    {
        id: 1,
        title: "Suivi stratégique de vos performances",
        image: service1,
        description: "Livrables concrets : Dashboards personnalisés faciles à lire, suivi précis des conversions, rapports automatisés mensuels, recommandations d'optimisation actionnables immédiatement.",
        subtitle: "On configure vos outils analytics (GA4, GTM, Looker Studio, Search Console) pour vous donner une vision claire et complète de votre performance. Vous savez exactement quels contenus génèrent des revenus, quels parcours convertissent le mieux, et où investir votre prochain dollar marketing pour maximiser votre retour. ",
    ...
    },
    {
        ...
        image: service2,
        description: "Livrables concrets : Audit technique approfondi avec plan d'action priorisé, correction des erreurs bloquantes, optimisation de performance (Core Web Vitals), données structurées avancées pour rich snippets, architecture d'information optimisée, suivi technique mensuel automatisé.",
        subtitle: "Vous obtenez un site techniquement parfait avec des données structurées qui boostent vos rich snippets et une stratégie de contenu qui génère du trafic organique qualifié ce qui signifie plus de visibilité dans les SERP, une meilleure expérience utilisateur et davantage de conversions.",
    ...
    },
    {
        ...
        image: service3,
        description: "Livrables concrets : Stratégie éditoriale trimestrielle alignée sur vos objectifs, calendrier de publication, rédaction optimisée SEO/GEO, structure de maillage interne, optimisation de vos contenus existants.",
        subtitle: "On produit du contenu ciblé et optimisé pour générer du trafic qualifié, convertir vos visiteurs, atteindre vos objectifs et maximiser votre ROI. Chaque page, chaque article a un rôle précis, aligné sur votre stratégie globale et les attentes de votre audience. Finis les contenus créés au hasard : tout ce que vous publiez sert maintenant un objectif clair.",
    ...
    },
    {
        ...
        title: "Formation",
        image: service4,
        description: "Livrables concrets : Sessions de coaching personnalisées, guides stratégiques et templates réutilisables, processus documentés étape par étape, support continu pour vos questions.",
        subtitle: "On forme vos équipes aux meilleures pratiques avec des sessions concrètes adaptées à votre réalité d'entreprise. Pas de théorie inutile : des compétences directement applicables dès le lendemain. Vos équipes gagnent en autonomie, exécutent plus rapidement et obtiennent de meilleurs résultats — sans dépendre constamment d'externes.",
    ...
    {
        id: 5,
        title: "Votre marque est invisible dans les réponses d'IA",
        description: "Articles, pages de services, guides. Vous créez du contenu, mais impossible de mesurer précisément son impact sur votre trafic et vos conversions.",
        link: "/service-details-light",
    },
    {
        id: 6,
        title: "Vous publiez du contenu sans savoir s'il performe vraiment",
        description: "Articles, pages de services, guides... Vous créez du contenu, mais impossible de mesurer précisément son impact sur votre trafic et vos conversions.",
        link: "/service-details-light",
    },
    {
        id: 7,
        title: "Vous manquez de temps pour maîtriser SEO et le GEO",
        description: "Vous savez que l'optimisation pour les moteurs de recherche ET les moteurs génératifs est cruciale. Mais entre gérer votre entreprise et devenir expert en marketing digital, vous ne pouvez pas tout faire.",
        link: "/service-details-light",
    },
    {
        id: 8,
        title: "Votre ROI marketing est difficile à calculer",
        description: "Entre les leads qui entrent, ceux qui abandonnent en cours de route et ceux qui vous échappent complètement, difficile de savoir ce qui fonctionne vraiment.",
        link: "/service-details-light",
    },
